...
function EventDetails() {
  ...
  const bookButtonClass = soldOut
    ...
    : 'bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 hover:scale-[1.02] shadow-lg shadow-indigo-200 transition-all duration-300'

  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      <div className="relative overflow-hidden rounded-3xl border border-slate-100 bg-white p-8 shadow-xl md:p-12">
        <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-gradient-to-br from-indigo-100/50 to-purple-100/50 blur-3xl" />
        ...
        <div className="relative z-10">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {fewLeft && !loading && (
              <span className="inline-flex items-center gap-1.5 rounded-full border border-orange-200 bg-orange-50 px-4 py-1.5 text-sm font-bold text-orange-700 shadow-sm transition-all duration-300 hover:bg-orange-100">
          ...
          <dl className="mt-12 grid gap-8 border-t border-slate-100 pt-10 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-2xl border border-transparent bg-slate-50 p-6 transition-all hover:border-slate-100 hover:bg-white hover:shadow-md">
            ...
            <div className="rounded-2xl border border-indigo-100 bg-indigo-50/50 p-6 transition-all hover:bg-indigo-50 hover:shadow-md">
              <dt className="flex items-center gap-2 text-sm font-semibold text-indigo-800">
                <svg className="h-5 w-5 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" /></svg>
                Tickets available
              </dt>
          ...
          <div className="mt-12 rounded-2xl bg-slate-50 p-8 leading-relaxed text-slate-600">
            ...
            <ul className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <li className="flex items-start gap-4 rounded-xl border border-slate-100 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
                <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-pink-100 text-pink-600">
